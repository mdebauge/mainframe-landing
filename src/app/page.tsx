  ...
  return (
    <main className="p-6 md:p-16 xl:p-24 bg-background overflow-hidden">
      <section className="mt-20 xl:mt-8 md:mb-24">
        ...
        <div className="relative h-[45vw] mt-28">
          <div className="absolute w-[60vw] -rotate-[5deg] -left-[5%] drop-shadow-xl">
            <Image src={dataScreen} alt="Data screenshot" />
          </div>
          <div className="absolute w-[60vw] rotate-[9deg] -right-[8%] drop-shadow-xl">
