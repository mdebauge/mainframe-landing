  ...
  return (
    <section className="mt-4 mb-12 prose">
      ...
      <p>
        ...
        Mainframe for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        opinions of Mainframe,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Mainframe shall not be liable
      ...
      <p>
        ...
        the hyperlink compensates the absence of Mainframe; and (d) the link is
