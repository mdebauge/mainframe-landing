  ...
  return (
    <section className="mt-4 mb-12 prose">
      ...
      <p>
        ...
        advertisements and links that appear on Mainframe, which are sent
      ...
      <p>
        Mainframe does not knowingly collect any Personal Identifiable
